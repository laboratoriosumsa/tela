...
LiveSphereCtrl.$inject = ["$scope", "$rootScope", "envService", "$stateParams", "ngMeta", "lptSphere", "LptHelper", "$http", "Alertify", "project"];
angular.module('lapentor.livesphere')
    .controller('LiveSphereCtrl', LiveSphereCtrl);

function LiveSphereCtrl($scope, $rootScope, envService, $stateParams, ngMeta, lptSphere, LptHelper, $http, Alertify, project) {
    var vm = this,
...
function env(envServiceProvider) {
    ...
    envServiceProvider.config({
        ...
        vars: {
            ...
            development: {
                apiUrl: 'https://api.lapentor.com/api/v1',
                siteUrl: 'http://app.lapentor.local',
                planMonthly: 15,
                planYearly: 12.5
            },
            production: {
...
LptHelper.$inject = ["$http", "$controller"];
angular.module('pst.utils')
...
ProfileCtrl.$inject = ["$scope", "$rootScope", "Alertify", "envService", "Upload", "user", "User"];
angular.module('lapentor.app')
...
Hotspot.$inject = ["$q", "$http", "lptSphere", "envService", "LptHelper"];
angular.module('lapentor.app')
...
Scene.$inject = ["$q", "$http", "$state", "LptHelper", "envService"];
...
SceneGroup.$inject = ["$q", "$http", "$state", "envService", "Alertify"];
angular.module('lapentor.app')
 ...
 */
angular.module('lapentor.marketplace.themes')
    .directive('hotspot', ["$compile", "$sce", "$timeout", "$window", "$uibModal", "$rootScope", "LptHelper", "ngAudio", "Alertify", function($compile, $sce, $timeout, $window, $uibModal, $rootScope, LptHelper, ngAudio, Alertify) {
        return {
            restrict: 'E',
            scope: {
...
pluginIntropopupConfigCtrl.$inject = ["$scope", "$http", "$rootScope", "$timeout", "$ocLazyLoad", "lptSphere", "LptHelper", "project", "item"];
angular.module('lapentor.marketplace.plugins')
...
HotspotEditablePointCtrl.$inject = ["$scope", "$rootScope", "$sce", "$timeout", "lptSphere", "Alertify", "Hotspot", "LptHelper"];
angular.module('lapentor.app')
...
EditorScenesManagementCtrl.$inject = ["$scope", "$uibModal", "User", "$timeout", "$state", "$rootScope", "Alertify", "LptHelper", "Scene", "SceneGroup"];
RenderingModalCtrl.$inject = ["$scope", "$timeout", "$filter", "$state", "$rootScope", "$uibModalInstance", "Media", "user", "Alertify", "Scene"];
angular.module('lapentor.app')
...
EditorToolbarCtrl.$inject = ["$scope", "$rootScope", "LptHelper", "Alertify", "Hotspot", "Project", "Scene"];
angular.module('lapentor.app')
 ...
 */
angular.module('lapentor.marketplace.themes')
    .directive('hotspotDefaultVideo', ["$uibModal", function($uibModal) {
        return {
            restrict: 'E',
            controller: ["$scope", "$state", "$sce", function($scope, $state, $sce) {
                var vm = this;
 ...
 */
angular.module('lapentor.marketplace.themes')
    .directive('hotspotGradyVideo', ["$uibModal", function($uibModal) {
        return {
            restrict: 'E',
            controller: ["$scope", "$state", "$sce", function($scope, $state, $sce) {
                var vm = this;
                ...
                function onclick() {
                    modal = $uibModal.open({
                        templateUrl: 'modules/lapentor.marketplace/themes/hotspot/grady/tpl/video.html',
                        scope: $scope,
                        controllerAs: 'vm',
                        controller: ["$scope", "$uibModalInstance", "$filter", function($scope, $uibModalInstance, $filter) {
                            var vm = this;
 ...
 */
angular.module('lapentor.marketplace.themes')
    .directive('hotspotRoyalVideo', ["$uibModal", function($uibModal) {
        return {
            restrict: 'E',
            controllerAs: 'vm',
            controller: ["$scope", "$state", "$sce", function($scope, $state, $sce) {
                ...
                function onclick() {
                    ...
                    modal = $uibModal.open({
                        templateUrl: 'modules/lapentor.marketplace/themes/hotspot/royal/tpl/video.html',
                        scope: $scope,
                        controller: ["$scope", "$uibModalInstance", "$filter", function($scope, $uibModalInstance, $filter) {
                            vm.cancel = function() {
                                $uibModalInstance.dismiss('cancel');
